...
const pieceWidth = PUZZLE_SIZE / PUZZLE_ROWS;
const pieceHeight = PUZZLE_SIZE / PUZZLE_COLUMNS;
...
const StyledPiece = styled.div`
  ...
  background-position: ${props => props.intendedColumn * -pieceWidth}px
    ${props => props.intendedRow * -pieceHeight}px;
